...
- 見やすくするため、インターフェースの案内文章を赤色にしました。
...
- 100点で採点すると何点でしょうか。
- 今回は4つのクラスに分けて作りました。コードレビューされた方ならどういうクラス分けをされますか？
- 対話型のminitestによるテストコードが書けず、手動でテストしました。参考になるサイトや書籍があれば教えて下さい。

#### 3.4.2 その他
- ひとつの言語を究めるエンジニアと、多言語を扱えるエンジニアでは、どちらが人材として求められますか？
- DIVE INTO CODEの卒業生のレベルは、この業界に入るための最低限の力を身につけたといえますか？
- 卒業まであと1ヶ月なのですが「Ruby以外でこの知識は深めておくべき」というものがあれば教えてください。
